...
import { ledger_key, balance_of_request, fa2_multi, transfer_destination, transfer_param } from './binding/fa2_multi';
...
describe('[FA2 multi-asset] Contracts deployment', () => {
...
describe('[FA2 multi-asset] Contract configuration', () => {
...
describe('[FA2 multi-asset] Minting', () => {
...
describe('[FA2 multi-asset] Transfers', () => {
...
describe('[FA2 multi-asset] Balance of', () => {
